...
- 🟡 [107-security-audit](./audit/107-security-audit-2026-06-01.md) — security baseline; top findings CLOSED 2026-06-11 verify: F-107-01 widget_secrets `hasOnly` in rules + F-107-02 CORS (PR #720 `f5eab8c0`) + F-107-03 widget CSP present in firebase.json; residual = KNOWN-OPEN list + F-101-03 (2026-06-01)
- ⏸️ [108-admin-redesign-smoke-blocked](./audit/108-admin-redesign-smoke-blocked-2026-06-02.md) — Tier 3 admin panelBg smoke; blocker CLEARED (PRs #646+#647 MERGED 2026-06-02) — re-run still pending (2026-06-02)
