...
- **SF-047 — subdomainService auth gate + rate limit (MED)**: already closed via #509 (bundled with audit/52 doc PR). Documented here for SECURITY_FIXES tracker completeness.
