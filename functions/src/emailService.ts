...
export async function sendTrialExpiredEmail(
  ...
  try {
    const params: TrialExpiredParams = {
      guestEmail: email,
      guestName: sanitizeText(name) || "Korisnik",
      upgradeUrl: "https://app.bookbed.io/subscription?utm_source=trial_expired&utm_medium=email",
    };
