 ...
 *
 * Supports both onRequest (Express-like) and onCall (CallableRequest) formats.
 *
...
export function getClientIp(request: any): string {
  // onCall has rawRequest, onRequest IS the request
 ...
 * @return Hashed IP string (truncated for use as rate limit key)
 */
