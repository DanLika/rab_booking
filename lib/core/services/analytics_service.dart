...
class AnalyticsService {
  ...
  Future<void> setUserId(String userId) async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error setting user ID', e, stackTrace);
    }
  }
  ...
  Future<void> setUserProperty(String name, String value) async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error setting user property', e, stackTrace);
    }
  }
  ...
  Future<void> logBookingCreated({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging booking_created', e, stackTrace);
    }
  }
  ...
  Future<void> logBookingConfirmed({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging booking_confirmed', e, stackTrace);
    }
  }
  ...
  Future<void> logBookingCancelled({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging booking_cancelled', e, stackTrace);
    }
  }
  ...
  Future<void> logPropertyViewed({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging property_viewed', e, stackTrace);
    }
  }
  ...
  Future<void> logUnitViewed({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging unit_viewed', e, stackTrace);
    }
  }
  ...
  Future<void> logAddPropertyStart() async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging add_property_start', e, stackTrace);
    }
  }
  ...
  Future<void> logPropertyCreated({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging property_created', e, stackTrace);
    }
  }
  ...
  Future<void> logViewSubscription({required int currentUnitCount}) async {
    try {
      ...
      LoggingService.logDebug('[Analytics] View subscription (units: $currentUnitCount)');
    } catch (e, stackTrace) {
      await LoggingService.logError('[Analytics] Error logging view_subscription', e, stackTrace);
    }
  }
  ...
  Future<void> logBeginCheckout({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging begin_checkout', e, stackTrace);
    }
  }
  ...
  Future<void> logSubscriptionPurchase({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging subscription_purchase', e, stackTrace);
    }
  }
  ...
  Future<void> logLogin(String method) async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging login', e, stackTrace);
    }
  }
  ...
  Future<void> logSignUp(String method) async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging sign_up', e, stackTrace);
    }
  }
  ...
  Future<void> logWidgetLoaded({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging widget_loaded', e, stackTrace);
    }
  }
  ...
  Future<void> logDateSelectionStarted() async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging date_selection_started', e, stackTrace);
    }
  }
  ...
  Future<void> logGuestDetailsEntered() async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging guest_details_entered', e, stackTrace);
    }
  }
  ...
  Future<void> logStripePaymentInitiated({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging stripe_payment_initiated', e, stackTrace);
    }
  }
  ...
  Future<void> logStripePopupBlocked({
    ...
    try {
      ...
      LoggingService.logDebug('[Analytics] Stripe popup blocked: $browser, $deviceType');
    } catch (e, stackTrace) {
      await LoggingService.logError('[Analytics] Error logging stripe_popup_blocked', e, stackTrace);
    }
  }
  ...
  Future<void> logStripePaymentCompleted({
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging stripe_payment_completed', e, stackTrace);
    }
  }
  ...
  Future<void> logSearch(String searchTerm) async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging search', e, stackTrace);
    }
  }
  ...
  Future<void> logCustomEvent(
    ...
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging custom event', e, stackTrace);
    }
  }
  ...
  Future<void> logScreenView(String screenName) async {
    try {
      ...
      await LoggingService.logError('[Analytics] Error logging screen_view', e, stackTrace);
    }
  }
}
