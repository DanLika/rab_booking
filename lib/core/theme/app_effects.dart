...
class AppEffects {
  ...
  static final ImageFilter blurStrong = ImageFilter.blur(
    sigmaX: 16,
    sigmaY: 16,
  );

  /// Extra strong blur effect (sigma 24)
  static final ImageFilter blurExtraStrong = ImageFilter.blur(
    sigmaX: 24,
    sigmaY: 24,
  );
  ...
  static Border get hairlineBorderDark =>
      Border.all(color: AppColors.borderDark, width: 0.5);

  /// Thin border (standard)
  static Border get thinBorder => Border.all(color: AppColors.borderLight);

  /// Thin border (dark mode)
  static Border get thinBorderDark => Border.all(color: AppColors.borderDark);

  /// Medium border (emphasis)
  static Border get mediumBorder =>
      Border.all(color: AppColors.borderLight, width: 2.0);

  /// Medium border (dark mode)
  static Border get mediumBorderDark =>
      Border.all(color: AppColors.borderDark, width: 2.0);

  /// Thick border (strong emphasis)
  static Border get thickBorder =>
      Border.all(color: AppColors.borderLight, width: 3.0);

  /// Thick border (dark mode)
  static Border get thickBorderDark =>
      Border.all(color: AppColors.borderDark, width: 3.0);
  ...
  static Border get secondaryBorder =>
      Border.all(color: AppColors.secondary, width: 2.0);
  ...
  static BoxDecoration get scrimOverlayLight =>
      const BoxDecoration(color: AppColors.scrimLight);

  /// Scrim overlay (dark mode)
  static BoxDecoration get scrimOverlayDark =>
      const BoxDecoration(color: AppColors.scrimDark);

  /// Gradient overlay for images (dark bottom)
  static BoxDecoration get imageOverlay =>
      const BoxDecoration(gradient: AppColors.overlayGradient);
  ...
  static Border customBorder({required Color color, double width = 1.0}) {
