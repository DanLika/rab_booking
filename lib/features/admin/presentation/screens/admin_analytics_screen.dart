...
import '../../../owner_dashboard/presentation/providers/analytics_provider.dart';
import '../providers/admin_analytics_provider.dart';
import '../../../../core/theme/app_colors.dart';
import '../../../../core/theme/app_typography.dart';
import '../../../../shared/widgets/error_state_widget.dart';

/// Admin Analytics Screen - Platform-wide analytics for all properties
class AdminAnalyticsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final analyticsAsync = ref.watch(
      adminAnalyticsNotifierProvider(dateRange: dateRange),
    );
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ref.invalidate(adminAnalyticsNotifierProvider);
            },
          ),
        ],
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Revenue Chart
          const _SectionTitle(title: 'Platform Revenue Over Time'),
          const SizedBox(height: 16),
          _RevenueChart(data: analytics.revenueHistory),
          const SizedBox(height: 32),

          // Bookings Chart
          const _SectionTitle(title: 'Platform Bookings Over Time'),
          const SizedBox(height: 16),
