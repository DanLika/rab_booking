...
class DashboardOverviewTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userName = authState.userModel?.firstName ?? user?.displayName?.split(' ').first;
        ...
        child: Builder(
          builder: (context) {
            ...
            if (properties.isEmpty && !propertiesAsync.hasError) {
              return _buildWelcomeScreen(context, l10n, theme, isMobile, userName);
            }
                  ...
                  children: [
                    Expanded(
                      child: _ActionStepCard(
                        ...
                        subtitle: 'Start getting bookings today',
                    ...
                    Expanded(
                      child: _ActionStepCard(
                        ...
                        subtitle: 'Sync with Airbnb & Booking.com',
                        icon: Icons.sync_rounded,
                        gradient: context.gradients.primaryAccent,
                    ...
                    Expanded(
                      child: _ActionStepCard(
                        ...
                        subtitle: 'Automate your payouts',
                        icon: Icons.payments_rounded,
                        gradient: context.gradients.success,
                        onTap: () =>
              ...
              child: IgnorePointer(
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 24),
                    // Only show revenue chart for preview
                    SizedBox(
                      height: 300,
