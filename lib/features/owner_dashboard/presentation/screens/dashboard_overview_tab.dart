...
class DashboardOverviewTab extends ConsumerWidget {
  ...
  Widget _buildStatCard({
    ...
    // Ensure strict minimum width for very small screens (< 320px)
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Adjust height for landscape mobile to avoid taking up full screen
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Adjust height for landscape mobile
        final double chartHeight;
        if (screenWidth > 900) {
          chartHeight = 300.0;
        } else if (screenWidth > 600) {
