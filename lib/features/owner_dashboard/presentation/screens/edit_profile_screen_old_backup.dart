...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen>
    ...
    try {
      ...
      if (mounted) {
        ...
        ErrorDisplayUtils.showErrorSnackBar(
          context,
          e,
          userMessage: 'Greška pri spremanju profila',
        );
      }
    }
  }
  ...
  Widget _buildLocationContactTab() {
    return ListView(
      ...
      children: [
        // Premium Personal Info Section Header
        Container(
        ...
        // Premium Address Section Header
        Container(
          padding: const EdgeInsets.only(left: 4, bottom: 12),
          child: Row(
            children: [
  ...
  Widget _buildCompanyTab() {
    return ListView(
      padding: const EdgeInsets.all(16.0),
      children: [
        // Premium Company Information Header
        Container(
          padding: const EdgeInsets.only(left: 4, bottom: 12),
          child: Row(
            children: [
        ...
        // Premium Banking Section Header
        Container(
          padding: const EdgeInsets.only(left: 4, bottom: 12),
          child: Row(
            children: [
        ...
        // Premium Company Address Section Header
        Container(
          padding: const EdgeInsets.only(left: 4, bottom: 12),
          child: Row(
            children: [
