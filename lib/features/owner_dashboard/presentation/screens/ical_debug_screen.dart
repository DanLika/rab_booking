...
/// Debug screen for testing iCal export functionality
///
/// Features:
/// - Manual trigger for iCal generation
/// - Preview of generated .ics content
/// - Copy URL to clipboard
/// - Test instructions for external calendars
class IcalDebugScreen extends ConsumerStatefulWidget {
  final UnitModel unit;
  final String propertyId;

  const IcalDebugScreen({
    super.key,
    required this.unit,
  ...
  @override
  ConsumerState<IcalDebugScreen> createState() => _IcalDebugScreenState();
}

class _IcalDebugScreenState extends ConsumerState<IcalDebugScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('iCal Export Debug'),
