...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Future<void> _handleSignOutFromAllDevices() async {
    ...
    try {
      ...
      await ref.read(enhancedAuthProvider.notifier).signOutFromAllDevices();

      // Navigate to login screen after successful sign out
      if (mounted) {
        ErrorDisplayUtils.showInfoSnackBar(
          scaffoldMessenger, // Use local variable
          l10n.ownerProfileSignOutFromAllDevicesSuccess,
        );
        router.go(OwnerRoutes.login);
      }
    } catch (e) {
      if (mounted) {
  ...
  void _showSignOutFromAllDevicesDialog() {
    final l10n = AppLocalizations.of(context);
    showDialog(
      context: context,
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          title: Text(l10n.ownerProfileSignOutFromAllDevices),
          content: Text(l10n.ownerProfileSignOutFromAllDevicesConfirmation),
          actions: [
            TextButton(
            ...
            FilledButton(
              child: Text(l10n.ownerProfileSignOut),
              onPressed: () {
                Navigator.of(dialogContext).pop();
                _handleSignOutFromAllDevices();
              },
            ),
          ],
        );
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                                ...
                                children: [
                                  PremiumListTile(
                                    ...
                                    subtitle: isAnonymous
                                        ...
                                        : l10n
                                            .ownerProfileEditProfileSubtitle,
                                    onTap: isAnonymous
                                        ? null
                                        : () => context
                                            .push(OwnerRoutes.profileEdit),
                                  ),
                                  if (!isAnonymous) ...[
                                    Divider(
                                      height: 1,
                                    ...
                                    PremiumListTile(
                                      ...
                                      title:
                                          l10n.ownerProfileChangePassword,
                                      subtitle: l10n
                                          .ownerProfileChangePasswordSubtitle,
                                      onTap: () => context.push(
                                    ...
                                    PremiumListTile(
                                      ...
                                      title: l10n
                                          .ownerProfileSignOutFromAllDevices,
                                      subtitle: l10n
                                          .ownerProfileSignOutFromAllDevicesSubtitle,
                                      onTap: _showSignOutFromAllDevicesDialog,
                                    ),
                                  ],
                                  Divider(
                                    height: 1,
                                  ...
                                  PremiumListTile(
                                    ...
                                    title: l10n
                                        .ownerProfileNotificationSettings,
                                    subtitle: l10n
                              ...
                              child: Column(
                                children: [
                                  PremiumListTile(
                                    ...
                                    subtitle:
                                        l10n.ownerProfileHelpSupportSubtitle,
                                    onTap: () {
                                      ErrorDisplayUtils.showInfoSnackBar(
                                        context,
                                        l10n
                                            .ownerProfileHelpSupportComingSoon,
                                      );
                                    },
                                  ),
                                  Divider(
                                  ...
                                  PremiumListTile(
                                    ...
                                    subtitle:
                                        l10n.ownerProfileAboutSubtitle,
                                    onTap: () =>
                                        context.push(OwnerRoutes.about),
                                    isLast: true,
                                  ),
                                ],
                              ),
                              ...
                              child: Column(
                                children: [
                                  PremiumListTile(
                                    ...
                                    title:
                                        l10n.ownerProfileTermsConditions,
                                    subtitle: l10n
                                        .ownerProfileTermsConditionsSubtitle,
                                    onTap: () => context
                                        .push(OwnerRoutes.termsConditions),
                                  ),
                                  Divider(
                                    height: 1,
                                    indent: 56,
                                  ...
                                  PremiumListTile(
                                    ...
                                    subtitle: l10n
                                        .ownerProfilePrivacyPolicySubtitle,
                                    onTap: () => context
                                        .push(OwnerRoutes.privacyPolicy),
                                  ),
                                  Divider(
                                    height: 1,
                                    indent: 56,
                                  ...
                                  PremiumListTile(
                                    ...
                                    subtitle: l10n
                                        .ownerProfileCookiesPolicySubtitle,
                                    onTap: () => context
                                        .push(OwnerRoutes.cookiesPolicy),
                                    isLast: true,
                                  ),
                                ],
                              ),
          ...
          if (_isLoading)
            const LoadingOverlay(message: 'Signing out from all devices...'),
        ],
      ),
    );
  }
