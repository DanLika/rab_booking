...
class _BookingCreateDialogState extends ConsumerState<BookingCreateDialog> {
  ...
  Future<void> _createBooking() async {
    ...
    try {
      ...
      // SECURITY FIX: Use BookingService to call atomic Cloud Function
      // This enforces server-side validation (double booking, etc.) for owner bookings
      final bookingService = ref.read(bookingServiceProvider);
      await bookingService.createBooking(
        unitId: _selectedUnitId!,
        propertyId: ref
            .read(ownerUnitsProvider)
            .value!
            .firstWhere((unit) => unit.id == _selectedUnitId)
            .propertyId,
        ...
        paymentOption: 'full', // Owner bookings are considered fully paid
        paymentMethod:
            _paymentMethod, // cash, card, bank_transfer, other (from dropdown)
        requireOwnerApproval:
            false, // Owner bookings should be instantly confirmed
