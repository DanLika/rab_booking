...
import 'booking_card_actions.dart';

/// Card widget for a single imported reservation (iCal event)
/// Uses same visual design as regular booking cards for consistency
class ImportedReservationCard extends ConsumerWidget {
  final IcalEvent event;

  const ImportedReservationCard({super.key, required this.event});
