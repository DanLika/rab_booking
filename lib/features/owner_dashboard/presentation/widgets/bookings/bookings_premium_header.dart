          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                // "Kasnije"/"Odgovori" removed (audit F4.8): both were
                // onPressed: () {} no-ops, and the pending queue directly
                // below carries the real Odobri/Odbij actions. Re-add only
                // when a dismiss/deep-link feature exists.
              ],
            ),
          ),
        ],
