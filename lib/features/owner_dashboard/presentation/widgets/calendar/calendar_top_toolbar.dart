          ...
          if (isCompact)
            ...
            Row(
              ...
              children: [
                ...
                if (activeFilterCount != null && activeFilterCount! > 0) _buildActiveFilterGroup(theme, l10n),
                ...
                // Filter button
                if (onFilterTap != null && (activeFilterCount == null || activeFilterCount == 0))
                  _buildStyledIconButton(
                    icon: Icons.tune,
                ...
                if (showEmptyUnitsToggle && onEmptyUnitsToggleChanged != null)
                  _buildStyledIconButton(
                    ...
                    tooltip: isEmptyUnitsVisible ? l10n.ownerCalendarHideEmptyUnits : l10n.ownerCalendarShowEmptyUnits,
                    isDark: theme.brightness == Brightness.dark,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Badge(
                    ...
                    child: const Icon(Icons.tune, size: 18, color: AppColors.warning),
                  ),
                ),
              ),
            ),
            ...
            // Vertical Divider
            VerticalDivider(width: 1, thickness: 1, indent: 6, endIndent: 6, color: borderColor),
            ...
            Tooltip(
              ...
              child: InkWell(
                ...
                child: Container(
                  width: 40, // Slightly narrower since it has no badge, but touch target adequate
                  alignment: Alignment.center,
