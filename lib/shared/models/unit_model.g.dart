...
_$UnitModelImpl _$$UnitModelImplFromJson(
  ...
  maxTotalCapacity: (json['max_total_capacity'] as num?)?.toInt(),
  extraBedFee: (json['extra_bed_fee'] as num?)?.toDouble(),
  petFee: (json['pet_fee'] as num?)?.toDouble(),
  maxPets: (json['max_pets'] as num?)?.toInt(),
...
Map<String, dynamic> _$$UnitModelImplToJson(
  ...
  'max_total_capacity': instance.maxTotalCapacity,
  'extra_bed_fee': instance.extraBedFee,
  'pet_fee': instance.petFee,
  'max_pets': instance.maxPets,
