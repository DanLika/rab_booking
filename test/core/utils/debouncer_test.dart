...
void main() {
  group('Debouncer', () {
    ...
    test('cancels previous action if called multiple times within delay', () async {
      int counter = 0;
      final debouncer = Debouncer(delay: const Duration(milliseconds: 50));
  ...
  group('Throttler', () {
    ...
    test('dispose() prevents timer from resetting readiness but allows pending sync code', () async {
      int counter = 0;
      final throttler = Throttler(duration: const Duration(milliseconds: 50));
