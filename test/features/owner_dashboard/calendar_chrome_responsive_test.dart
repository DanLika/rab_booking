// Responsive + fidelity render harness for the owner Timeline/Kalendar premium
// chrome — the premium header (eyebrow + "Kalendar" title + Timeline/Mjesečni
// view switch), the top toolbar, the status-badge legend card, and the FAB.
//
// Pumps the REAL chrome via `OwnerTimelineCalendarScreen.buildChromeForTest`
// (no Scaffold/drawer/Firebase — the FROZEN grid is swapped for a sized
// placeholder) across the full breakpoint range in light + dark.
//
